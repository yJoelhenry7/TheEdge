...
export function SiteFooter() {
  return (
    <footer className="border-t border-black/10 bg-white">
      {/* ── Contact bar ───────────────────────────────────────────── */}
      <div className="border-b border-black/10 bg-[#fafafa] px-6 py-8 sm:px-10">
        <div className="mx-auto flex max-w-[1400px] flex-col items-start gap-4 sm:flex-row sm:items-center sm:justify-between">
          ...
          <Link
            href="tel:9182891252"
            className="font-sans text-2xl font-medium tracking-tight text-foreground transition-opacity hover:opacity-60 sm:text-3xl"
          >
            +91 82891 252
          </Link>
        </div>
      ...
      <div className="px-6 py-14 sm:px-10 sm:py-16">
        <div className="mx-auto max-w-[1400px] grid gap-12 sm:grid-cols-[1fr_auto_auto]">
          ...
          <div className="flex flex-col gap-5">
            ...
            <p className="max-w-xs font-sans text-sm leading-relaxed text-muted-foreground">
              Consulting, connectivity, and careers. Precision, performance and reliability.
            </p>
            <Link
              href="mailto:info@vvrindustries.com"
              className="font-sans text-sm text-foreground underline-offset-4 transition-opacity hover:opacity-60 hover:underline"
            >
      ...
      <div className="border-t border-black/10 px-6 py-5 sm:px-10">
        <div className="mx-auto flex max-w-[1400px] flex-col gap-2 sm:flex-row sm:items-center sm:justify-between">
          <p className="font-sans text-xs text-muted-foreground">
            © {new Date().getFullYear()} VVR Industries Limited. All rights reserved.
          </p>
          <p className="font-sans text-xs text-muted-foreground">
